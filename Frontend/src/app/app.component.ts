...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, RouterLink, BackgroundLeavesComponent, RouterLinkActive, NgIf, NgClass, LoadingSpinnerComponent, ModalHostComponent],
...
export class AppComponent {
  ...
  openLoginModal(){
    this.universalModal.open({ body: UserModalComponent });
  }
