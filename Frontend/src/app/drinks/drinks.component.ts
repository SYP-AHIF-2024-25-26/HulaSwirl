...
export class DrinksComponent {
  ...
  openModal(m:ModalType,data:any=null) {
    if (m === ModalType.AddDrink) {
      this.modal.open({ body: DrinkModalComponent, data: { mode: 'add' }, rawBody: true });
    } else if (m === ModalType.EditDrink) {
      this.modal.open({ body: DrinkModalComponent, data: { mode: 'edit', drink: data }, rawBody: true });
    }
  }
}
